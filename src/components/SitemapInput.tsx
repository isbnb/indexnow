...
import { Globe, ArrowRight, AlertCircle, Info } from 'lucide-react';
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Enter Your Sitemap URL</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              {exampleUrls.map((url, index) => (
                <button
                  ...
                  className="block w-full text-left text-sm text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-3 py-2 rounded transition-colors duration-200 break-all"
                >
                  {url}
                </button>
              ))}
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center font-medium text-sm sm:text-base"
          >
            Continue
